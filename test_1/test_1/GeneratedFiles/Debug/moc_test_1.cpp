...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_test_1_t, stringdata) + ofs \
...
const QMetaObject test_1::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_test_1.data,
      qt_meta_data_test_1,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_test_1.stringdata))
        return static_cast<void*>(const_cast< test_1*>(this));
