...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_test_qt_t, stringdata) + ofs \
...
const QMetaObject test_qt::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_test_qt.data,
      qt_meta_data_test_qt,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_test_qt.stringdata))
